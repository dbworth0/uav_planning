...
#include <planning_through_pointclouds/ply_io.h>
...
*/
  ...
  std::vector<float> xyz_source(xyz_values); // function requires non-const vector<T>
  ply_file.add_properties_to_element<float>("vertex", {"x", "y", "z"}, xyz_source);

  //ply_file.comments.push_back("generated by tinyply");
  ply_file.write(os, binary_format);
                  ...
                  const bool binary_format)
{
  ...
  std::vector<float> p4_source(property_4_values);
  ply_file.add_properties_to_element<float>("vertex", {property_4_name}, p4_source);

  std::vector<float> p5_source(property_5_values);
  ply_file.add_properties_to_element<float>("vertex", {property_5_name}, p5_source);


  std::vector<int> p6_source(property_6_values);
  ply_file.add_properties_to_element<int>("vertex", {property_6_name}, p6_source);
